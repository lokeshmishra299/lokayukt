    ...
    <div className="min-h-screen bg-gray-50 ">
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 transition-colors"
        >
            ...
            <tbody>
              {scannedLetters.map((row) => (
                <tr key={row.id} className="bg-white border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-800">{row.subject}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-fadeIn">
              ...
              <div>
                ...
                {!selectedFile ? (
                    ...
                    <div 
                        ...
                        className="border-2 border-dashed border-blue-200 rounded-lg bg-blue-50/50 p-8 text-center cursor-pointer hover:bg-blue-50 transition-colors group"
                    >
            ...
            <div className="p-5 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
              ...
              <button className="px-4 py-2 text-sm font-medium text-white bg-blue-800 rounded-lg hover:bg-blue-900 transition-colors shadow-sm">
                Upload & Attach
              </button>
            </div>
          </div>

...
const EditModal = ({ 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      switch (activeTab) {
        case 'districts':
          endpoint = `/lokayukt/edit-district/${editingItem.id}`;
          requestData = {
          ...
          break;
        case 'departments':
          endpoint = `/lokayukt/edit-department/${editingItem.id}`;
          requestData = {
            name: formData.name,
          ...
          break;
        case 'subjects':
          endpoint = `/lokayukt/edit-subject/${editingItem.id}`;
          requestData = {
            name: formData.name,
          ...
          break;
        case 'designations':
          endpoint = `/lokayukt/edit-designation/${editingItem.id}`;
          requestData = {
            name: formData.name,
            name_h: formData.nameHi
          };
        ...
        case 'complaint-types':
          endpoint = `/lokayukt/edit-complainstype/${editingItem.id}`;
          requestData = {
            name: formData.name,
            name_h: formData.nameHi,
        ...
        case 'rejection-reasons':
          endpoint = `/lokayukt/edit-rejection/${editingItem.id}`;
          requestData = {
            name: formData.name,
            name_h: formData.nameHi,
            description: formData.description
...
const MasterData = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      try {
        ...
        const rejectionReasonsResponse = await api.get('/lokayukt/rejections');
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      switch (activeTab) {
        case 'districts':
          endpoint = `/lokayukt/delete-district/${deletingItem.id}`;
          break;
        case 'departments':
          endpoint = `/lokayukt/delete-department/${deletingItem.id}`;
          break;
        case 'subjects':
          endpoint = `/lokayukt/delete-subject/${deletingItem.id}`;
          break;
        case 'designations':
          endpoint = `/lokayukt/delete-designation/${deletingItem.id}`;
          break;
        case 'complaint-types':
          endpoint = `/lokayukt/delete-complainstype/${deletingItem.id}`;
          break;
        case 'rejection-reasons':
          endpoint = `/lokayukt/delete-rejection/${deletingItem.id}`;
          break;
        default:
          toast.error('Invalid tab selected');
          return;

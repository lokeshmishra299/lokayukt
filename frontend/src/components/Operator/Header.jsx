...
const Header = () => {
 ...
 <div className="w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center">
      ...
      <div className="flex-1 flex justify-center">
        <button className="flex items-center gap-2 border px-4 py-1.5 rounded-lg text-gray-700 bg-gray-50 hover:bg-gray-100">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          <div className="w-9 h-9 rounded-full bg-yellow-500 flex items-center justify-center">
            <span className="text-white font-semibold">SX</span>
          </div>

          <span className="text-sm font-medium text-gray-700">
            Shri XYZ, PS to Lokayukta
          </span>
